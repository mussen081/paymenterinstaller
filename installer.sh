...
echo "In welcher Sprache möchten Sie den Installer verwenden? / In what language do you want to use the installer / En que idioma deseas utilizar el instalador?"
